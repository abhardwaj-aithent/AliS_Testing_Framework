...
public class FeeDetail_PaymentGateway_Tab {
	...
	public void ReturnToHome() {
		WebElement RTH=driver.findElement(By.xpath("//button[contains(text(),'Return to Home')]"));
		RTH.click();
		WebElement ViewPendingLink=driver.findElement(By.id("ctl00_ContentPlaceHolder1_ucMenu_1__aMenuLink"));
		ViewPendingLink.click();
		WebElement TXNNO= driver.findElement(By.xpath("//span[@id='ctl00_ContentPlaceHolder1_ucPendingApplication_ucGridUserControl_ResultsGrid_ctl02_lblTransactionNumber']"));
		System.out.println(TXNNO.getText());
	}
